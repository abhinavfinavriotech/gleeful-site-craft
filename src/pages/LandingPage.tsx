...
const features = [
  ...
  {
    icon: AlertTriangle,
    title: 'Allegation Types',
    description: 'Categorize complaints by fraud type for accurate risk assessment',
  },
  {
    icon: Zap,
    title: 'Real-time Updates',
    description: 'Get instant updates when new complaints are filed',
  },
];
      ...
      <section className="bg-card py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              { step: '01', title: 'Report Abusers', description: 'Brokers submit complaints with category and allegation type' },
              { step: '02', title: 'Score Calculated', description: 'System automatically calculates risk score based on complaints' },
