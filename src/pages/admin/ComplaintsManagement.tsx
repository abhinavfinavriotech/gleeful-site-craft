    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">View and manage all abuser records</p>
        </div>
          ...
          <DialogContent className="max-w-3xl">
            ...
            {selectedComplaint && (
              <div className="space-y-6">
                {/* Complaint Info */}
                <div>
                  <h3 className="font-semibold mb-3">Complaint Information</h3>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{selectedComplaint.subCategory}</p>
                    </div>

                    <div>
                      <p className="text-sm text-muted-foreground">Allegation</p>
                      <p className="font-medium">
                        {getAllegationName(selectedComplaint.allegationTypeId)}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {getBrokerName(selectedComplaint.reportedBy)}
                      </p>
                    </div>
                ...
                {/* Abuser Details */}
                <div>
                  <h3 className="font-semibold mb-3">Abuser Details</h3>

                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-muted-foreground">Name</p>
                      <p className="font-medium">{selectedComplaint.abuser.name}</p>
                    </div>

                    <div>
                      <p className="text-sm text-muted-foreground">Contact</p>
                      <p className="font-medium">{selectedComplaint.abuser.contact}</p>
                    </div>

                    <div className="col-span-2">
                      <p className="text-sm text-muted-foreground">Address</p>
                      <p className="font-medium">{selectedComplaint.abuser.address}</p>
                    </div>

                    <div>
                      <p className="text-sm text-muted-foreground">City</p>
                      <p className="font-medium">{selectedComplaint.abuser.city}</p>
                    </div>

                    <div>
                      <p className="text-sm text-muted-foreground">Country</p>
                      <p className="font-medium">{selectedComplaint.abuser.country}</p>
                    </div>

                    <div className="col-span-2">
                      <p className="text-sm text-muted-foreground">Email IDs</p>
                      <ul className="list-disc list-inside">
                        {selectedComplaint.abuser.emails.map((email, i) => (
                          <li key={i}>{email}</li>
                        ))}
                      </ul>
                    </div>
                    ...
                    <div className="col-span-2">
                      <p className="text-sm text-muted-foreground">IP Addresses Used</p>
                      <ul className="list-disc list-inside">
                        {selectedComplaint.abuser.ips.map((ip, i) => (
                          <li key={i}>{ip}</li>
                        ))}
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {selectedComplaint.abuser.documentType}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {selectedComplaint.abuser.documentNumber}
                      </p>
                    </div>
                  </div>
                </div>
