...
export default function AllegationManagement() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editing) {
      ...
      toast({ title: 'Activity type added successfully' });
    }
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage Activity Types for scoring</p>
          </div>
          <Dialog open={isDialogOpen} onOpenChange={(open) => {
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>{editing ? 'Edit Activity Type' : 'Add New Activity Type'}</DialogTitle>
                <DialogDescription>
                  Activity Types are used for risk scoring
                </DialogDescription>
              </DialogHeader>
